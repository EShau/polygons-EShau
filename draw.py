    ...
    for lat in range(lat_start, lat_stop):
        for longt in range(longt_start, longt_stop+1):
            ...
            add_polygon(polygons,
                        ...
                        points[index][1],
                        points[index][2],
                        points[(index+1)%length][0],
                        points[(index+1)%length][1],
                        points[(index+1)%length][2],
                        points[(index+steps+1)%length][0],
                        points[(index+steps+1)%length][1],
                        points[(index+steps+1)%length][2])
            if longt != 0:
                add_polygon(polygons,
                            points[index][0],
                            points[index][1],
                            ...
                            points[(index+steps+1)%length][1],
                            points[(index+steps+1)%length][2],
                            points[(index+steps)%length][0],
                            points[(index+steps)%length][1],
                            points[(index+steps)%length][2])
        ...
        for longt in range(longt_start, longt_stop):
            ...
            if longt != longt_stop-1:
                ...
                add_polygon(polygons,
                            ...
                            points[(index+1)%length][1],
                            points[(index+1)%length][2],
                            points[(lat*steps)%length][0],
                            points[(lat*steps)%length][1],
                            points[(lat*steps)%length][2])
